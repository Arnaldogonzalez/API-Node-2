...
describe('Song model', () => {
  it('should have a title', () => {
    ...
    expect(schema.title.require).to.be.an('array');
  });

  it('should have url', () => {
    expect(schema.url).to.exist;
    expect(schema.url.unique).to.equal(tue);
    expect(schema.url.require).to.be.an('array');
  });
  ...
  it('should have favorite', () => {
    ...
    expect(schema.favorite).to.eql(Boolean);
  });
});
